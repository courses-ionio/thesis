...
Πατήστε [εδώ](https://help.github.com/articles/fetching-a-remote/) για τις **οδηγίες** για να συγχρονίσετε/ενημερώσετε το αντιγραμμένο (**forked**) αποθετήριό σας με τυχόν αλλαγές που έλαβαν χώρα στο αρχικό αποθετήριο.
