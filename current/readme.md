...
Σε περίπτωση που θέλετε να συγχρονίσετε/ενημερώσετε το αντιγραμμένο (**forked**) αποθετήριό σας με τυχόν αλλαγές που έλαβαν χώρα στο αρχικό αποθετήριο (από τότε που το αντιγράψατε), οδηγίες θα βρείτε [εδώ](https://help.github.com/articles/fetching-a-remote/).
