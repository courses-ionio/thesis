...
Για αναλυτικές οδηγίες σχετικά με την **εγγραφή**, την **επεξεργασία και υποβολή παραδοτέων**, την **προσθήκη εικόνων** και τη **διαγραφή αρχείων** [πατήσετε εδώ](https://courses-ionio.github.io/help/guide/).

Οι οδηγίες που παρέχονται στον παραπάνω σύνδεσμο είναι γενικές για όλα τα μαθήματα. Συνεπώς, στα πλαίσια της πτυχιακής σας εργασίας, μπορετε να αγνοήσετε εκείνες τις οδηγίες που αναφέρονται στην επεξεργασία των αρχείων της επιμέρους εφαρμογής-άσκησης.
