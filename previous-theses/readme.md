...
Θα πρέπει να σημειωθεί ότι οι συγκεκριμένες πτυχιακές **δεν** προβάλλονται ως πρότυπα για κάθε είδους πτυχιακή, αλλά ως ενδεικτικές εργασίες που προβάλλονται σαν μελέτη περίπτωσης.
